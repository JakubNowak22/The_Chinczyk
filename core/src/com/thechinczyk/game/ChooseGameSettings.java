...
public class ChooseGameSettings implements Screen {
    ...
    public void render(float delta) {
        ...
        if (menuButtonFunc(buttonX, buttonXClicked, buttonXHovered, Gdx.graphics.getDeltaTime(),
        ...
        if (chooseMapNumber != 0 && playerCount != 0) {
            ...
            if (menuButtonFunc(buttonPLAY, buttonPLAYClicked, buttonPLAYHovered, Gdx.graphics.getDeltaTime(),
        ...
        if (menuButtonFunc(buttonMD, buttonMDClicked, buttonMDHovered, Gdx.graphics.getDeltaTime(),
                buttonMDHoveredSprite, false)) {
            chooseMapNumber = 1;
        }
        if (menuButtonFunc(buttonMN, buttonMNClicked, buttonMNHovered, Gdx.graphics.getDeltaTime(),
                buttonMNHoveredSprite, false)) {
            chooseMapNumber = 2;
        }
        if (menuButtonFunc(buttonP2, buttonP2Clicked, buttonP2Hovered, Gdx.graphics.getDeltaTime(),
                buttonP2HoveredSprite, false)) {
            playerCount = 2;
        }
        if (menuButtonFunc(buttonP3, buttonP3Clicked, buttonP3Hovered, Gdx.graphics.getDeltaTime(),
                buttonP3HoveredSprite, false)) {
            playerCount = 3;
        }
        if (menuButtonFunc(buttonP4, buttonP4Clicked, buttonP4Hovered, Gdx.graphics.getDeltaTime(),
                buttonP4HoveredSprite, false)) {
            playerCount = 4;
        }
        /*if (mainMenuBackgroundBluredSpriteAlpha > 0) { // animacja wyjścia z menu z ustwaieniami gry
            if (mainMenuBackgroundBluredSpriteAlpha > 0.15f) {
                ...
                mainMenuBackgroundBluredSprite.setAlpha(mainMenuBackgroundBluredSpriteAlpha = 0);
            }
            mainMenuBackgroundBluredSprite.draw(game.batch);
        }*/ //do usunięcia albo poprawy może będzie jakiś commit zrobiony
