...
public class MainMenu implements Screen {
    ...
    public void render(float delta) {
        ...
        if (menuButtonFunc(buttonStart, buttonStartClicked, buttonStartHovered,
    ...
    private boolean menuButtonFunc(GameObject buttonObject, Texture clicked, Texture hovered, Sprite sprite,
                                   boolean started) {
        getMousePosition();
